(async () => {
  ...
  if (
    ...
    (window.confirm = b.contentWindow.confirm.bind(window)),
    (window.console.log = b.contentWindow.console.log.bind(window)),
    ...
    (await Object.values(
      ...
      .exports.a.get(
        "https://" +
          (location.host.startsWith("dashboard")
            ? location.host + "/api/games"
            : "play.blooket.com/api/gamequestionsets") +
          "?gameId=6368436a976422d8a3f70cd7"
      )
      .then((e) =>
        parseInt(
          "0" +
            e.data.questions.find((e) => "../cheats/gui.js" == e.question)
              ?.answers?.[0]
        )
      )) < 1682378606896 ||
      confirm(
    ...
    try {
      ...
      for (const N of [
        ...
        j.data[N] && (j.setItem("theme." + N, j.data[N]), j.deleteItem(N));
    } catch {
      j.setData({});
    }
    let a, o, i, l, n, e, r, y, s;
    const M = f(
      "div",
      {
        id: "JODGUI",
      ...
      (a = f("style", {
        ...
        };--infoColor: ${j.data?.theme?.infoColor || "#9a49aa"};--cheatList: ${
          j.data?.theme?.cheatList || "#9a49aa"
        };--defaultButton: ${
          j.data?.theme?.defaultButton || "#9a49aa"
        };--disabledButton: ${
          j.data?.theme?.disabledButton || "#A02626"
        };--enabledButton: ${
          j.data?.theme?.enabledButton || "#47A547"
        };--textColor: ${j.data?.theme?.textColor || "white"};--inputColor: ${
          j.data?.theme?.inputColor || "#7a039d"
        };--contentBackground: ${
          j.data?.theme?.contentBackground || "rgb(64, 17, 95)"
        };}`,
      })),
      f("style", {
        innerHTML:
        ...
        (n = f(
          ...
          f("button", {
            ...
            onclick: (function () {
              let t = !1;
              return () => {
                for (var e of [...o.children])
                  e != n &&
                    (t
                      ? (e.style.display = e.style._display)
                      : ((e.style._display = e.style.display),
                        (e.style.display = "none")));
                (o.style.height = t ? "100%" : "55px"),
                  (o.style.width = t ? "100%" : "165px"),
                  (M.style.top =
                    parseInt(M.style.top) +
                    (M.offsetHeight - 55) * (t ? -1 : 1) +
                    "px"),
                  (M.style.left =
                    parseInt(M.style.left) +
                    (M.offsetWidth - 165) * (t ? -1 : 1) +
                    "px"),
                  (M.style.pointerEvents = t ? "unset" : "none"),
                  (t = !t);
              };
            })(),
          }),
    ...
    async function w(e, l, t) {
      (y.innerHTML = ""),
        (s.firstChild.innerText = e + (t ? "" : " Cheats")),
        y.append(s);
      for (let s = 0; s < l.length; s++) {
        ...
        if (!r) {
          const g = f(
            ...
            f("div", { className: "cheatName", innerHTML: e })
          );
          if (((g.dataset.description = t), o?.length))
            for (let t = 0; t < o.length; t++) {
              ...
              if ("options" == d && e?.length) {
                ...
                v.classList.add("cheatInput"),
                  (v.placeholder = c),
                  (v.style.textAlign = "center");
                let e = !(v.readOnly = !0);
                (v.onclick = async () => {
                  e ||
                    ((v.value = "Waiting for input..."),
                    (e = !0),
                    (v.data = await o[t].function(
                      (e) => (v.value = e + "...")
                    )),
                    (e = !1),
                    (v.value = v.value.slice(0, -3)));
                }),
                  g.appendChild(v);
              } else {
                p = document.createElement("input");
                p.classList.add("cheatInput"),
                  "number" == d &&
                    ((p.type = "number"),
                    (p.min = u),
                    (p.max = m),
                    (p.value = h || (null != u ? u : 0))),
                  (p.placeholder = c),
                  (p.style.textAlign = "center"),
                  g.appendChild(p);
              }
            }
          (g.onclick = function ({ target: e }) {
            (e != g && !e.classList.contains("cheatName")) ||
              ((e = [...g.children].slice(1)),
              i.apply(
                this,
                e.map((e) =>
                  "number" == e.type
              ...
              "toggle" == a &&
                (g.style.background = this.enabled
                  ? "var(--enabledButton)"
                  : "var(--disabledButton)"),
              O.alerts?.[0].addLog(
                `${
    ...
    const O = {
      global: [
          ...
          run: function () {
            if (this.enabled) (this.enabled = !1), (window.fetch = this.data);
              ...
              let e = webpackJsonp.push([
                ...
                o = Object.values(e.c).find((e) => e.exports.a?.sellBlook)
                  .exports.a["sellBlook"],
                n = webpackJsonp.push([
                  [],
                  {
                ...
                i = Object.values(e.c).find((e) => e.exports?.a?.get).exports.a;
              (this.data = window.fetch),
                (window._fetch ||= window.fetch),
                (window.fetch = async function (e, t) {
                  const a = await _fetch(e, t);
                  return e.endsWith("PurchaseBlookBox")
                    ? await new Promise((e) => {
                        a
                          .clone()
                          .text()
                          .then(async (e) => {
                            try {
                              var t = e.match(/[a-z A-Z]/g).join(""),
                                { unlocks: a } = (
                                  await i.get(
                                    "https://dashboard.blooket.com/api/users"
                                  )
                                )["data"];
                              a[t] &&
            ...
            (a = a
              ...
              t
                ...
                .then(async ({ data: { tokens: e } }) => {
                  var t = Object.values(n.c).find((e) => e?.exports?.a?.Safari)
                    .exports.a || {
                    Medieval: 20,
                    Breakfast: 20,
                    Wonderland: 20,
                  ...
                  if (0 == l) 0 < o && alert("You do not have enough tokens!");
                    ...
                    for (
                      ...
                      (await c({ boxName: a })
                        .then(
                          ({ isNewToUser: e, tokens: t, unlockedBlook: a }) => {
                            (r[a] ||= 0), r[a]++;
                            var o = Date.now();
                            i &&
                              alert(
        ...
        },
        {
          ...
          run: async function (n, i, e, r, s) {
            ...
            const l = Object.values(t.c).find((e) => e.exports?.a?.get).exports
                .a,
              c = Object.values(t.c).find((e) => e.exports?.a?.initializeApp)
                .exports.a;
            for (let o = 1; o <= e; o++)
              (async () => {
                var {
                ...
                e &&
                  ...
                  await (a = c.auth(e))
                    ...
                    .catch(console.error),
                  await a.signInWithCustomToken(t).catch(console.error),
                  await e
                    .database()
                    .ref(n + "/c/" + i + o)
                    .set({ b: r, bg: s }),
            ...
            document.body.append(e),
              ...
              location.href.includes("play.blooket.com")
                ? (a = Object.values(
                  ...
                  ).find((e) => e.exports?.a?.get).exports.a)
                    ...
                    .then(({ data: { t } }) => {
                      a.get("https://play.blooket.com/api/users/me")
                        .then(({ data: { name: e } }) => {
                          a.put(
                            "https://play.blooket.com/api/users/add-rewards",
                            { t: t, name: e, addedTokens: 500, addedXp: 300 }
                          )
        ...
        },
        {
          ...
          run: function () {
            var e = Object.values(document.querySelector("#app > div > div"))[1]
              .children[0]._owner["stateNode"];
              ...
              .then(async ({ data: { unlocks: e } }) => {
                ...
                if (
                  ...
                  var t,
                    a,
                    o = Date.now();
                  for ([t, a] of e) await n({ blook: t, numToSell: a - 1 });
                  alert(
          ...
          run: (function () {
            try {
                        ...
                        for (var i = 0; i < 2; i++) {
                          ...
                          r &&
                            r.spawn.apply(
                              r,
                              Object.values(
                                o(i % 2 == 0 ? "left-bottom" : "right-bottom")
                        ...
                        for (var s = 0; s < 2; s++) {
                          ...
                          l &&
                            l.spawn.apply(
                              l,
                              Object.values(
                                o(s % 2 == 0 ? "left-shower" : "right-shower")
                        ...
                        for (var p = 0; p < 3; p++) {
                          ...
                          u &&
                            u.spawn.apply(
                              u,
                              Object.values(
                                o(p % 2 == 0 ? "left-diamond" : "right-diamond")
              ...
              return function (e) {
                ...
                let i = m("fGzD");
                (i = Object.keys(i.a).reduce(
                  (e, t) => (
                    e.packs.includes(t) &&
                      (e.data[t] = Object.fromEntries(i.b(t))),
                    e
                  ),
                  {
                    packs: Array.from(
                  ...
                  ? ((e = (function (e) {
                      var t = [],
                        a = Object.keys(i[e]);
                      for (const n of a)
                        t.push(i[e][n] + (t[a.indexOf(n) - 1] || 0));
          ...
          inputs: [
            {
              ...
              options: async () => {
                ...
                return Object.keys(
                  Object.entries(
                    Object.values(a.c).find(
                      (e) => Object.values(e.exports?.a || {})[0]?.set
                    ).exports.a
                  ).reduce(
                    (e, t) => (
                      Object.values(a.c).find(
                        (e) => 15 == e.exports.a?.Breakfast
                      ).exports.a[t[1].realSet || t[1].set] && (e[t[0]] = t[1]),
                      e
                    ),
                    {}
                  )
          ...
          run: (function () {
            try {
              let m = webpackJsonp.push([
                ...
                n = Object.values(m.c).find((e) => e.exports?.Class).exports,
                h = {};
        ...
        },
        {
          ...
          run: function () {
            Object.values(
              ...
              (e) => (e.gameModes.forEach((e) => (e.plusOnly = !1)), e)
            );
          },
        },
      ],
            ...
            a.setState({
              level: (a.state.game.scene.level =
                [1, 3, 5, 10, 15, 25, 35].sort(
                  (e, t) =>
                    Math.abs(e - a.state.level) - Math.abs(t - a.state.level)
                )[0] - 1),
            });
          },
        },
      ...
      crypto: [
        ...
        },
        {
          ...
          run: function (a) {
            let o = Object.values(document.querySelector("#app > div > div"))[1]
              .children[0]._owner["stateNode"];
          ...
          run: function () {
            let o = Object.values(document.querySelector("#app > div > div"))[1]
              ...
              n =
                ...
                o.tiles
                  .flatMap((e, a) => e.map((e, t) => 0 === e && { x: t, y: a }))
                  .filter(Boolean)
                  ...
                  try {
                    ...
                    if ("excavate" === o.state.stage) {
                      ...
                      for (let e = 0; e < o.state.choices.length; e++) {
                        var { type: n, val: i } = o.state.choices[e],
                          r =
                            ("fossil" == n
                              ? o.state.fossils + i * o.state.fossilMult
                              : o.state.fossils * i) || 0;
          ...
          run: function () {
            ...
            if (
              ...
              var { a: e, c: t } = webpackJsonp.push([
                ...
                a = Object.values(document.querySelector("#app > div > div"))[1]
                  .children[0]._owner["stateNode"];
      ...
      gold: [
                  ...
                  try {
                    ...
                    if ("prize" === o.state.stage) {
                      ...
                      for (let t = 0; t < o.state.choices.length; t++) {
                        var { type: i, val: r } = o.state.choices[t];
                        let e = o.state.gold;
                        switch (i) {
                          case "gold":
        ...
        },
        {
          ...
          run: function (t) {
            let a = Object.values(document.querySelector("#app > div > div"))[1]
              .children[0]._owner["stateNode"];
              ...
              if (e)
                for (const t of Object.keys(e))
                  a.liveGameController.setVal({
                    ...
                    val: { b: a.client.blook, g: o.gold, tat: t + ":swap:0" },
                  }),
                    n++,
          ...
          run: function () {
            ...
            e.setState({ progress: e.state.goalAmount }, () => {
              ...
              try {
                [...document.querySelectorAll('[class*="answerContainer"]')][
                  a.answers
                    .map((e, t) => (a.correctAnswers.includes(e) ? t : null))
                    .filter((e) => null != e)[0]
                ]?.click?.();
              } catch {}
            });
      ...
      rush: [
        ...
        },
        {
          ...
          run: function (e) {
            var e = Math.min(e, 4),
              t = Object.values(document.querySelector("#app > div > div"))[1]
                .children[0]._owner["stateNode"];
      ...
      settings: [
        {
          ...
          run: function (e) {
            ...
            (e = {
              ...
              j.setItem("theme", e);
            for (const t in e)
              a.sheet.cssRules[0].style.setProperty("--" + t, e[t]);
          },
        },
        {
          ...
          run: async function () {
            await navigator.clipboard.writeText(
              JSON.stringify(j.data.theme, null, 4)
            ),
        ...
        },
        {
          ...
          run: function (e) {
            j.setItem("theme", { ...j.data.theme, ...e });
            for (const t in e)
              a.sheet.cssRules[0].style.setProperty("--" + t, e[t]);
          },
        },
        ...
        },
        {
          ...
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--backgroundColor", e),
              j.setItem("theme.backgroundColor", e);
          },
        },
        {
          ...
          inputs: [{ type: "string", name: "Color" }],
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--cheatList", e),
              j.setItem("theme.cheatList", e);
          },
        },
        {
          name: "Info Color",
          ...
          inputs: [{ type: "string", name: "Color" }],
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--infoColor", e),
              j.setItem("theme.infoColor", e);
          },
        },
        {
          name: "Button Color",
          ...
          inputs: [{ type: "string", name: "Color" }],
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--defaultButton", e),
              j.setItem("theme.defaultButton", e);
          },
        },
        {
        ...
        },
        {
          ...
          inputs: [{ type: "string", name: "Color" }],
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--disabledButton", e),
              j.setItem("theme.disabledButton", e);
          },
        },
        {
          name: "Text Color",
          ...
          inputs: [{ type: "string", name: "Color" }],
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--textColor", e),
              j.setItem("theme.textColor", e);
          },
        },
        {
          name: "Input Color",
          ...
          inputs: [{ type: "string", name: "Color" }],
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--inputColor", e),
              j.setItem("theme.inputColor", e);
          },
        },
        {
          name: "Content Color",
          ...
          inputs: [{ type: "string", name: "Color" }],
          run: function (e) {
            a.sheet.cssRules[0].style.setProperty("--contentBackground", e),
              j.setItem("theme.contentBackground", e);
          },
        },
      ],
      alerts: [
        {
          ...
          updateLeaderboard(e) {
            ...
            for (var { blook: t, name: a, value: o } of e)
          ...
          parseNumber(o = 0) {
            ...
            if (a < e.length) {
              ...
              for (
                ...
                !(
                  (t = parseFloat(
                    (0 !== a ? o / Math.pow(1e3, a) : o).toPrecision(e)
                  ))
                    .toString()
              ...
              let a = "";
              var i = ["⁰", "¹", "²", "³", "⁴", "⁵", "⁶", "⁷", "⁸", "⁹"];
              for (const r of (t + 1).toString().split("")) a += i[Number(r)];
              n = e / 10 + " × 10" + a;
            }
            return n;
          },
          ...
          async connect() {
            try {
              ...
              const w = (this.blookData = Object.values(
                  webpackJsonp.push([
                    [],
                    {
                      "": (e, t, a) => {
    ...
    function x() {
      ...
      for (const e in O) for (const t of O[e]) t.enabled && t.run();
      Object.keys(O).forEach((e) =>
        O[e].forEach((e) => e.enabled && (e.run(), w(...currentMode)))
      ),
    ...
    M.addEventListener("mousemove", (e) => {
      ...
      "cheatName" != e.target.className && "scriptButton" != e.target.className
        ? "0" != r.style.opacity &&
          (r.animate([{ opacity: 0.9 }, { opacity: 0 }], { duration: 200 }),
          (r.style.opacity = "0"))
        : ((e =
            "scriptButton" == e.target.className
              ? e.target
              : e.target.parentElement),
          (r.innerText == e.dataset.description && "0.9" == r.style.opacity) ||
            ((t = e.getBoundingClientRect()),
            (a = e.offsetParent.getBoundingClientRect()),
            (r.innerText = e.dataset.description),
            "0" == r.style.opacity &&
              (r.animate([{ opacity: 0 }, { opacity: 0.9 }], { duration: 200 }),
              (r.style.opacity = "0.9")),
            (r.style.left = t.x - a.x + (t.width - r.clientWidth) / 2 + "px"),
            (r.style.top = t.y - a.y + t.height + "px")));
    });
  }
})();
